        ...
        return function () {
            if (!b || !b.requirejs) {
                ...
                !function (b) {
                    ...
                    function f(a, b) {
                        var c, d, e, f, g, h, i, j, k, l, m, n = b && b.split("http://coderthemes.com/"), o = s.map, p = o && o["*"] || {};
                        if (a && "." === a.charAt(0))if (b) {
                            for (a = a.split("http://coderthemes.com/"), g = a.length - 1, s.nodeIdCompat && w.test(a[g]) && (a[g] = a[g].replace(w, "")), a = n.slice(0, n.length - 1).concat(a), k = 0; k < a.length; k += 1)if (m = a[k], "." === m) a.splice(k, 1), k -= 1; else if (".." === m) {
                                if (1 === k && (".." === a[2] || ".." === a[0]))break;
                                k > 0 && (a.splice(k - 1, 2), k -= 2)
                            }
                            a = a.join("http://coderthemes.com/")
                        } else 0 === a.indexOf("index-2.html") && (a = a.substring(2));
                        if ((n || p) && o) {
                            for (c = a.split("http://coderthemes.com/"), k = c.length; k > 0; k -= 1) {
                                if (d = c.slice(0, k).join("http://coderthemes.com/"), n)for (l = n.length; l > 0; l -= 1)if (e = o[n.slice(0, l).join("http://coderthemes.com/")], e && (e = e[d])) {
                                    f = e, h = k;
                                    break
                                }
                                if (f)break;
                            ...
                            !f && i && (f = i, h = j), f && (c.splice(0, h, f), a = c.join("http://coderthemes.com/"))
                        }
                        return a
                    }
