    ...
    <div class="container">
        ...
        <div class="card-box">
            <form method="GET" action="#" data-parsley-validate novalidate>
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="m-t-0 header-title"><b>Today's Delivery Repors </b></h4>
                        ...
                        <div class="form-group col-sm-8">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="input-daterange input-group" id="date-range">
                                    ...
                                    <span class="input-group-addon bg-custom b-0 text-white">Date</span>
                                    <input type="text" class="form-control" value="<?php  if (isset($_GET['from_date']))
                                    { echo $from_date;}?>" name="from_date" />
                                </div>
                            </div>
                        </div>
                    </div>
