                                ...
                                <tbody>
                                    <?php
                                        while($inv_row=  mysqli_fetch_assoc($cusReportResult))
                                        {
                                            ...
                                            if($av_count>0)
                                            {
                                                $invoice_total=  Report::getInvoiceTotal($inv_row['rox_inv_auto_id']);
                                                $invoice_paid= Report::getInvoicePaid($inv_row['rox_inv_auto_id']);
                                                if($invoice_paid=="")
                                                {
                                                    $invoice_paid=0.0;
                                                }
                                    ?>
                                    <tr>
                                        <td><?php echo $inv_row['rox_inv_id']; ?></td>
                                        <td><?php echo $cusdetails_row['cus_fname']; ?></td>
                                        <td><?php echo $inv_row['rox_inv_date']; ?></td>
                                        <td>Rs <?php echo $invoice_total; ?></td>
                                        <td>Rs <?php echo $invoice_paid; ?></td>
                                        <td>Rs <?php echo $inv_row['rox_inv_balance']; ?></td>
                                ...
                                <tbody>
                                    <?php
                                        while($inv_row=  mysqli_fetch_assoc($cusReportResult))
                                        {
                                            ...
                                            $avResult=Report::getInvoicePaymentType($invoice_id,$_POST['payment_method']);
                                            $av_count=  mysqli_num_rows($avResult);
                                            if($av_count>0)
                                            {
                                                if($invoice_paid=="")
