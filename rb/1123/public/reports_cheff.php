            ...
            <div class="col-sm-12">
                <div class="card-box">
                    <table id="demo-foo-filtering" class="table table-striped toggle-circle m-b-0" data-page-size="100">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <button onclick="location.href='functions/function_excell.php?out_by_date_2_cheff=yes&s_date='+ $('#from_date').val()+'&e_date='+ $('#to_date').val();"   class="btn btn-inverse waves-effect waves-light printid" id="btnPrint"><i class="fa fa-print"></i> Export</button>
                            </div>
                        </div>
