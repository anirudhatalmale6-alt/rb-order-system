								 ...
								 <button class="btn btn-primary waves-effect waves-light" type="submit">Search</button>
									<div class="col-sm-8">
                                        ...
                                        <select name="user_id" class="selectpicker" data-live-search="true"  data-style="btn-white">
                                            ...
                                            $load_all_user= Common_access::load_all_users();
                                            while ($row_cate = mysqli_fetch_array($load_all_user)) {
                                                ?>
                                                <option value="<?php echo $row_cate['rox_admin_id'];?>"><?php echo $row_cate['rox_user_name']; ?></option>
                                            <?php } ?>
                                        </select>
									</div>
                        ...
                        <div class="card-box">                           
                            <table id="demo-foo-filtering" class="table table-striped toggle-circle m-b-0" data-page-size="100">
                                ...
                                include("class/class_orders.php");
                                    if ($user_id == 0){
                                        $prdct=class_orders::select_all_between_date_only($f_date,$t_date);
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            ...
                                            <?php echo $data['rox_inv_auto_id'];?> </a>
