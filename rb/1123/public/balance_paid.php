                ...
                <table>
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <!--                            <img src="assets/site/images/brand/logo.png" style="width: 10%;max-width:300px;" >-->
        ...
        <tr class="information">
            <td colspan="6">
                <table>
                    <tr>
                        <td>
                            Invoice #<?php echo $inv_code;?> By : <?php echo $rox_admin_fname;?> <br>
                            Order Created: <?php echo $rox_inv_date;?><br>
                            Delivery Date: <?php echo $rox_del_date.'-'.$rox_inv_time;?>
                        </td>
...
//    $sum +=$rox_prd_price;
            ...
            if ($rox_dis_status == 1){
                ...
                echo ' <tr class="item">
                            ...
                            <td>'.$rox_gre_des.' '.$rox_gre_info.' '.$rox_gre.' '.$rox_gre_info2.' '.$rox_des.' </td>
                            <td>'.$rox_prd_qty_d.' </td>
...
//                        </tr>';
        ...
        <tr class="item last">
            ...
            <td> </td>
            <td> </td>
            <!--            <td align="right"> <pk>--><?php //echo ($sum+$sum2)-$rox_advc;?><!--.00 </pk></td>-->
            <td align="right"> <pk><?php echo $sum+$sum2+$rox_del_charge+$rox_ser_charge;?>.00 </pk></td>
        ...
        while($row=mysqli_fetch_array($vall)) {
            ...
            <tr class="item last">
                ...
                <td></td>
                <td></td>
                <td align="right"><?php echo $amn; ?>.00</td>
            </tr>
            <?php
            $i++;
        }
        ...
        <tr class="total">
            ...
            <td  align="right"><b><pk><k><?php  echo $amnt;?>.00</k></pk></b></td>
        </tr>
    </table>
