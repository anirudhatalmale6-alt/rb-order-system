                ...
                <table>
                    <tr>
                        <td  align="center">
                            ...
                            <b><font size="5px">The Royal Bakery</font></b><br>
                            <div style="line-height: 15px;font-size: 10px">No # 200,
                                Galle Road,Colombo 06 <br>
                                Hotline - 011 2 588476</div>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table>
                    <tr>
                        <td style="border-bottom:1px solid #dddddd;">
                            <div style="line-height: 18px">Invoice #<?php echo $inv_code;?> By : <?php echo $rox_admin_fname;?></div>
                            <div style="line-height: 18px">Order Created: <?php echo $rox_inv_date;?></div>
                            <div style="line-height: 18px">Delivery Date: <?php echo $rox_del_date.'-'.$rox_inv_time;?></div>

                        </td>
                    </tr>
                    <tr>
                        <td style="border-bottom:1px solid #dddddd;">
                            <div style="line-height: 18px"><?php echo $lname .'. '.$or_fname?></div>
                            <div style="line-height: 18px"><?php echo $address;?></div>
                            <!--                            Phone - --><?php //echo $tele;?><!--<br>-->
                            <div style="line-height: 15px">Mobile -  <?php echo $mobile;?></div>
                        </td>
                    </tr>
                </table>
            </td>
...
//                        </tr>';
                echo ' <tr>
                            <td colspan="4">'.$rox_prd_name.' - '.$rox_gre_des.'</td>
                        </tr>
            ...
            if ($rox_dis_status == 1){
                ...
                echo ' <tr>
                            <td colspan="4">'.$rox_prd_name. ' ('.$rox_dis_ti.')% - '.$rox_gre_des.'</td>
                        </tr>
                        <tr class="item">
    ...
    //
    //  ="form-control payment" id="Payment">
