                ...
                while($invoice=mysqli_fetch_array($invoices)){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" onclick="open_modal('<?= $invoice['rox_inv_auto_id']; ?>')"  id="authorized_link_<?php echo $invoice['rox_inv_auto_id'];?>" >Bill Authorize</a>
                            <?php  } ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                while($product=mysqli_fetch_array($products)) { ?>
                                                    ...
                                                    <div class="divTableCell">
                                                        ...
                                                        <input min2="<?= date('Y-m-d')?>" class="form-control" name="invoice[rox_inv_due]" value="<?php echo $invoice['rox_inv_due'];?>" type="date"></div>
                                                    
                                                <div class="divTableCell">
                                                    <label>Delivery Date </label>
                                                    <input min2="<?= date('Y-m-d')?>" class="form-control" name="invoice[delivery_date]" value="<?php echo $invoice['rox_del_date'];?>" type="date"></div>
                                                <div class="divTableCell">
