            ...
            <div class="container">
				...
				<?php
				 if(isset($_GET['id']))
				 {
					...
					$get_user = User_access::get_user($user_id);
				
				while ($row_user = mysqli_fetch_array($get_user)) {
				?>
					<form method="POST" action="functions/function_user_access.php?uid=<?php echo $_GET['id'];?>" data-parsley-validate novalidate>
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="form-group col-lg-4">
											...
											<input type="text" name="user_name" parsley-trigger="change"  placeholder="Enter User Name" class="form-control" id="user_name" value="<?php echo $row_user['rox_user_name']; ?>">
										</div>
										<div class="col-lg-12 col-lg-4">
											<div class="form-group col-lg-6">
												<label for="pass1">Password <span class="text-danger">*</span></label>
												<input id="pass1" type="password" name="password" placeholder="Password"
													   required class="form-control" value="<?php echo $row_user['rox_admin_password']; ?>">
											</div>
											<div class="form-group col-lg-6">
												<label for="passWord2">Confirm Password <span class="text-danger">*</span></label>
												<input data-parsley-equalto="#pass1" type="password" required
													   placeholder="Password" class="form-control" name="password2"  id="passWord2" value="<?php echo $row_user['rox_admin_password']; ?>">
											</div>
				...
				<?php
					...
					echo  '<script type="text/javascript">window.location="manage-users";</script>';
				}
				?>
				</div>
                <!-- Footer -->
