                        ...
                        <div class="card-box">
                            <form action="" method="post">
                                    ...
                                    <div class="col-md-3">
                                        <select class="form-control" id="customer" name="customer_name">
                                            ...
                                            <?php
                                              ...
                                              {
                                            ?>
                                            <option <?php if(isset($_REQUEST['customer_name'])){ if($customer_row['cus_id']==$_REQUEST['customer_name']){  ?> selected="selected" <?php } }  ?> value="<?php echo $customer_row['cus_id'];  ?>"><?php echo $customer_row['cus_fname']." "; ?></option>
                                            <?php
                                              }
                                            ?>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <select class="form-control" id="cat_id" required name="cat_id" onchange="loadfile(this.value);">
                                            <option>---</option>
                                            <?php
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3"><input value="<?= $_POST['start_date'] ?>" type="date" class="form-control"  name="start_date" id="start_date" required="required"/></div>
                                    <div class="col-md-1">To</div>
                                    <div class="col-md-3"><input value="<?= $_POST['end_date'] ?>" type="date" class="form-control"  name="end_date" id="end_date" required="required"/></div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">&nbsp;</div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <select class="form-control" id="payment_method" name="payment_method">
                                            ...
                                            <option <?php if(isset($_REQUEST['payment_method'])){ if('Cash'==$_REQUEST['payment_method']){  ?> selected="selected" <?php } }  ?> value="Cash">Cash</option>
                                            <option <?php if(isset($_REQUEST['payment_method'])){ if('Credit'==$_REQUEST['payment_method']){  ?> selected="selected" <?php } }  ?> value="Credit">Credit</option>
                                            <option <?php if(isset($_REQUEST['payment_method'])){ if('Cheque'==$_REQUEST['payment_method']){  ?> selected="selected" <?php } }  ?> value="Cheque">Cheque</option>
                                            <option <?php if(isset($_REQUEST['payment_method'])){ if('Staff'==$_REQUEST['payment_method']){  ?> selected="selected" <?php } }  ?> value="Staff">Staff</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
				...
				<div class="card-box">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <a onclick="reports_products_overall_export(event)" href="functions/function_excell.php?reports_products_only=yes" class="btn btn-inverse waves-effect waves-light printid" id="btnPrint"><i class="fa fa-print"></i> Export</a>
...
<!-- Modal-->
    ...
    function reports_products_overall_export(e) {
        e.preventDefault();
        ...
        if(start_date) {
            var url = "functions/function_excell.php?reports_products_overall=yes&cat_id=" + cat_id + "&sub_cat=" + sub_cat + "&start_date=" + start_date + "&end_date=" + end_date + "&item=" + item + "&payment_method=" + payment_method + "&customer=" + customer;
