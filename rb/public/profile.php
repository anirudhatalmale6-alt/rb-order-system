                    ...
                    <div class="row">
                        <div class="col-md-4 col-lg-3">
                            <div class="profile-detail card-box">
                                <div>
                                    <img src="assets/site/images/users/avatar-2.jpg" class="img-circle" alt="profile-image">
                            ...
                            <div class="card-box">
                                ...
                                <div class="friend-list">
                                    <a href="#">
                                        <img src="assets/site/images/users/avatar-1.jpg" class="img-circle thumb-md" alt="friend">
                                    </a>

                                    <a href="#">
                                        <img src="assets/site/images/users/avatar-2.jpg" class="img-circle thumb-md" alt="friend">
                                    </a>

                                    <a href="#">
                                        <img src="assets/site/images/users/avatar-3.jpg" class="img-circle thumb-md" alt="friend">
                                    </a>

                                    <a href="#">
                                        <img src="assets/site/images/users/avatar-4.jpg" class="img-circle thumb-md" alt="friend">
                                    </a>

                                    <a href="#">
                                        <img src="assets/site/images/users/avatar-5.jpg" class="img-circle thumb-md" alt="friend">
                                    </a>

                                    <a href="#">
                                        <img src="assets/site/images/users/avatar-6.jpg" class="img-circle thumb-md" alt="friend">
                                    </a>

                                    <a href="#">
                                        <img src="assets/site/images/users/avatar-7.jpg" class="img-circle thumb-md" alt="friend">
                                    </a>
                        ...
                        <div class="col-lg-9 col-md-8">
                            ...
                            <div class="card-box">
                                <div class="comment">
                                    <img src="assets/site/images/users/avatar-1.jpg" alt="" class="comment-avatar">
                                    <div class="comment-body">
                                        <div class="comment-text">
                                            ...
                                            <div class="m-t-15">
                                                <a href="#">
                                                    <img src="assets/site/images/small/img1.jpg" class="thumb-md">
                                                </a>
                                                <a href="#">
                                                    <img src="assets/site/images/small/img2.jpg" class="thumb-md">
                                                </a>
                                                <a href="#">
                                                    <img src="assets/site/images/small/img3.jpg" class="thumb-md">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="comment">
                                        <img src="assets/site/images/users/avatar-2.jpg" alt="" class="comment-avatar">
                                        <div class="comment-body">
                                            <div class="comment-text">
                                                <div class="comment-header">
                                    ...
                                    <div class="comment">
                                        <img src="assets/site/images/users/avatar-3.jpg" alt=""
                                        ...
                                        <div class="comment">
                                            <img src="assets/site/images/users/avatar-4.jpg" alt=""
                                                 class="comment-avatar">
                                            <div class="comment-body">
                                                <div class="comment-text">
                                                    <div class="comment-header">
                                ...
                                <div class="comment">
                                    <img src="assets/site/images/users/avatar-7.jpg" alt="" class="comment-avatar">
                                    <div class="comment-body">
                                        <div class="comment-text">
                                            <div class="comment-header">
