									...
									<div class="col-md-12">
                                        ...
                                        <select name="user_id" class="selectpicker" data-live-search="true"  data-style="btn-white">
                                            ...
                                            while ($row_cate = mysqli_fetch_array($load_all_cus)) {
                                                ...
                                                <option value="<?php echo $row_cate['cus_id'];?>"><?php echo $row_cate['cus_mobile']; ?>-<?php echo $row_cate['cus_fname']; ?></option>
                               ...
                               <tr>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="functions/function_excell.php?overall=yes&<?php echo $_SERVER['QUERY_STRING']?>" class="btn btn-inverse waves-effect waves-light printid" id="btnPrint"><i class="fa fa-print"></i> Export</a>
