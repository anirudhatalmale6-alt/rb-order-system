...
<div class="invoice-box">
    <table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr class="tr_inv"><td colspan="5" style="height:20px; text-align:left; font-size: 10px">V.A.T No: 409010172-7000</td></tr>
        <tr class="top tr_inv">
            <td colspan="6">
                <table>
                    <tr>
                        <td  align="center" style="margin-bottom: 1px; padding-bottom:1px; ">
                            ...
                            <h1 style="margin: 4px;">INVOICE</h1>
                        </td>
                    </tr>
        ...
        <tr class="tr_inv information">
            <td colspan="6" style="line-height: 12px;">
                <table>
                    <tr class="cus_info" style="width: 100%">
                        <td style="width: 25%">Cust. Name:</td>
                        <td style="width: 20%; text-align: left!important;"> &nbsp;<?php echo $lname .'. '.$or_fname?></td>
                        <td style="width: 10%">&nbsp;</td>
                        <td style="width: 25%">Inv. No:</td>
                        <td style="width: 20%; text-align: left;">&nbsp;<?php echo $inv_code;?>&nbsp;&nbsp;</td>
                    </tr>
                    ...
                    <tr class="" style="width: 100%">
                        ...
                        <td style="width: 20%; text-align: left;">&nbsp;<?php echo $rox_inv_time;?>&nbsp;&nbsp;</td>
                        <td style="width: 10%">&nbsp;</td>
                        <td style="width: 25%">&nbsp;</td>
                        <td style="width: 20%; text-align: left;">&nbsp;</td>
                    </tr>
...
//                        </tr>';
                if($dis_re) {
                    $dis_re=false;
                    echo '<tr class=" tr_inv item" align="right"> 
                    <td colspan="2" align="left">  </td>
                    <td colspan="2"> </td>
                    <td align="right"><pk> '.number_format($sum,2).'</pk></td>
                    </tr>
                    ';
                    echo '<tr class="tr_inv item" align="right"> 
                    ...
                    <td colspan="2" align="left">  </td>
                    <td colspan="2"> </td>
                    <td align="right"><pk> '.number_format($sum-($sum *($rox_dis_ti/100)),2).'</pk></td>
                    </tr>
                    ';
        ...
        <tr class=" tr_inv item">
            ...
            $finall = $a34+ $rox_del_charge;
            $finall1=($rox_ser_charge/100)*$finall;
            ...
            if (!$rox_dis_ti == '') {
                ...
                $subb=$finall+$finall2;
                ?>
                <td align="right"> <pk><?php echo number_format($subb,2);?></pk></td>
                <?php
            }
            else {

                ?>
                <td align="right"> <pk><?php echo number_format($subb1,2);?></pk></td>
                <?php
            }
            ?>
    ...
    <tr class=" item">
            ...
            if($ball==0)
            {
                ...
                ?>
                <td align="right"><b><pk><k><?php  echo "Paid";?></k></pk></b></td>
            ...
            {
                ?>
                <td align="right"><b><pk><k><?php  echo number_format($ball,2);?></k></pk></b></td>
                <input type="hidden" id="total_price" name="total_price" value="<?php echo $ball;?>.00">
                <?php
            }
            ?>
...
<!--      ////////////////////////////  -->
        <tr class="tr_inv"><td colspan="5" style="height:10px;"></td></tr>

        <tr class="tr_inv "><td colspan="5" style="padding-top: 100px; height:30px; text-align:center; border-top:1PX solid #C8C8C8;font-size: 10px">THANK YOU PLEASE COME AGAIN !</td></tr>
        <tr class="tr_inv" style="    line-height: initial;"><td colspan="5" style=" text-align:center; font-size: 10px">Software By EzyCode</td></tr>
        <tr class="tr_inv" style="    line-height: initial;"><td colspan="5" style=" text-align:center; font-size: 10px">www.ezycode.lk</td></tr>
    </table>
    <?php
...
<script>
    ...
    remove_payment_tr();
    function remove_payment_tr() {
        var set = $('.payment_tr');
        var length = set.length;
        if(length >1 ) {
            set.each(function (index, element) {
                var val = $(this).find(".payment_td").text();
                console.log(this);
                if (index === (length - 1)) {
                    ...
                    cols += '<td></td>';
                    cols += '<td></td>';
                    cols += '<td align="right">&nbsp; </td>';
                    newRow.append(cols);
                    $(this).closest('tr').before(newRow);

                  //  console.log('Last field, submit form here' + val);
                } else {
                    if (index > 0) {
                        var newRow = $('<tr id="">');
                        var cols = "";
