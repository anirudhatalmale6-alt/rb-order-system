                ...
                <div class="row">
                    ...
                    <div class="col-md-3" id="divv">
                        <div class="form-group">
                            ...
                            <select name="ord_p_m_typ" id="ord_p_m_typ" class="form-control" data-live-search="true" required data-style="btn-white">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="ord_p_s_typ" id="ord_p_s_typ" class="form-control" data-live-search="true" data-style="btn-white">
                    ...
                    <div class="col-md-3" id="prd_typ">
                        <div class="form-group">
                            ...
                            <select name="ord_prd_typ" id="ord_prd_typ" class="form-control"  required="" data-style="btn-white">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="odr_price" id="odr_price" >
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="odr_qty" id="odr_qty"  required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="odr_gre_des" class="control-label">Description</label>
                            <input type="text" class="form-control" name="odr_gre_des" id="odr_gre_des" >
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="odr_gre_info"  class="form-control" data-live-search="true"  id="odr_gre_info" data-style="btn-white">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="odr_gre">Greetings *</label>
                            <select name="odr_gre"  class="form-control" data-live-search="true"  id="odr_gre" data-style="btn-white">
                                <option value="">None</option>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="odr_gre_info2" id="odr_gre_info2" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="ord_status" class="form-control" data-live-search="true" required id="ord_status" data-style="btn-white">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form method="POST" action="functions/function_orders.php" data-parsley-validate novalidate>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="d_delivery" class="control-label">Date/Time of Delivery</label>
                                    <div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="odr_dis" >
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="odr_adv" class="control-label">Advance</label>
                                <input type="text" class="form-control" name="odr_adv" >
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="odr_del_chrge" class="control-label">Delivery Charge </label>
                                <input type="text" class="form-control"  name="odr_del_chrge" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  name="odr_sr_chrge" >
                            </div>
                        </div>
                    </div>
                </div>
...
//                            $('#ord_p_m_typ').selectpicker('refresh');
                    ...
                    for (var i = 0; i < len; i++) {
                        ...
                        $("#ord_add tbody").append('<tr>' +
                            '<td>' + prd + '</td>' +
                            '<td>' + des + ' | '+ rox_gre + ' | ' + rox_gre1 +' | '+ rox_gre2 + '</td>' +
                            '<td>' + prd_qty + '</td>' +
                            '<td>' + prd_price + '</td>' +
                            '<td>' + sum +'.00' +'</td>' +
...
$("#odr_gre_info2").keyup(function(e){ 
