            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Manage Main Categories</h4>
                        <ol class="breadcrumb">
					...
					<form action="functions/function_user_access.php" method="POST" data-parsley-validate novalidate>
						<div class="row">						
							<div class="col-lg-12">
								...
								<h4 class="m-t-0 header-title"><b>Feed Main Categories</b></h4>
								<p class="text-muted font-13 m-b-30">
									Main Categories added on here will be shown on down below.
								</p>
								<?php 
								if (isset($_GET['sa'])) {
									$status = $_GET['sa'];
								...
								<div class="form-group col-lg-3">
									<label for="main_cate_id">CAT ID#</label>
									<input type="text" name="main_cate_id" parsley-trigger="change" value="<?php include('class/class_autoid.php'); echo $get_main_cate_id = Autoid::get_main_cate_id(); ?>"required placeholder="CAT ID#" class="form-control" id="main_cate_id" readonly>
								</div>									
								<div class="form-group col-lg-4">
									<label for="main_cate">Main Category</label>
									<input type="text" name="main_cate" parsley-trigger="change" required placeholder="Enter Main Category" class="form-control" id="main_cate">
								</div>	
								<div class="form-group col-lg-5">
									<label for="main_cate_des">Main Category Description</label>
									<input type="text" name="main_cate_des" parsley-trigger="change" required placeholder="Enter Main Category Description" class="form-control" id="main_cate_des">
								</div>	
							</div>
						</div>
						<div class="row">				
                            ...
                            <table class="table table-striped" id="datatable-editable">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Main Category</th>
                                        <th>Main Category Description</th>
                                        <th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
								<?php
									...
									while ($row1 = mysqli_fetch_array($load_acc_main_cate)) {
									?>  
                                    <tr class="gradeA">
                                        <td><?php echo $row1['rox_auto_id']; ?></td>
                                        <td><?php echo $row1['rox_main_cate']; ?></td>
                                        <td><?php echo $row1['rox_main_cate_des']; ?></td>
                                        <td class="actions">
