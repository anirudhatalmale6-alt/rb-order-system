            ...
            <div class="col-sm-12">
                <div class="card-box">
                    <table id="demo-foo-filtering" class="table table-striped toggle-circle m-b-0" data-page-size="100">
                        ...
                        $load = User_access::load_customer();
                        while ($row = mysqli_fetch_array($load)) {
                            ...
                            <tr class="active">
                                ...
                                <td>
                                    <b><a href="#" class="text-dark"><b><?php echo $row['cus_mobile']; ?></b></a> </b>
                                </td>
                                <td>
                                    <b><a href="#" class="text-dark"><b><?php echo $row['cus_land']; ?></b></a> </b>
                                </td>
                                <td>
                                    <b><a href="#" class="text-dark"><b><?php echo $row['cus_address']; ?></b></a> </b>
                                </td>
                                <td>
                                    <b><a href="#" class="text-dark"><b><?php echo $row['cus_email']; ?></b></a> </b>
                                </td>
