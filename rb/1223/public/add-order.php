                        ...
                        <h4 class="m-t-0 header-title"><b>Fill customer information to create order</b></h4>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="date" onchange="TDate(this.value)" class="form-control" required name="d_delivery"   id="d_delivery" min="<?php echo date("Y-m-d"); ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="date" onchange="MDate(this.value)" class="form-control" id="To_Date" name="odr_date" min="<?php echo date("Y-m-d"); ?>" />
                                </div>
                            </div>
                        </div>
