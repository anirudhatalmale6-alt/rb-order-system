                    ...
                    <div class="col-sm-12">
                        <div class="card-box">
                            <table id="demo-foo-filtering" class="table table-striped toggle-circle m-b-0" data-page-size="100">
                                ...
                                <tbody>
                                <td><span class="label label-table label-inverse">Cancelled</span></td>
										<td>
                            ...
                            <table id="demo-foo-filtering" class="table table-striped toggle-circle m-b-0" data-page-size="7">
                                ...
                                <tbody>
                                    <tr>
                                        <td>ORD0001CAKE</td>
                                        <td>Caramal Cake</td>
                                        <td>Caramal Cake with Cashew Nuts</td>
                                        <td>Sameera Veerasinghe</td>
                                        <td>22 Jun 1972</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Sameera Veerasinghe</td>
                                        <td>22 Jun 1972</td>
                                        <td><span class="label label-table label-success">Prepared</span></td>
										<td>
											<a href="#" class="btn btn-success waves-effect waves-light"><i class="fa fa-edit"></i></a>
											<a href="#" class="btn btn-danger waves-effect waves-light"><i class="fa fa-trash"></i></a>
										</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Sameera Veerasinghe</td>
                                        <td>22 Jun 1972</td>
                                        <td><span class="label label-table label-info">Delivered</span></td>
										<td>
											<a href="#" class="btn btn-success waves-effect waves-light"><i class="fa fa-edit"></i></a>
											<a href="#" class="btn btn-danger waves-effect waves-light"><i class="fa fa-trash"></i></a>
										</td>
