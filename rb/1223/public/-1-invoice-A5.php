...
//                        </tr>';
                echo ' <tr>
                            <td colspan="4">'.$rox_prd_name.' - '.$rox_gre_des.' | '.$rox_gre_info.' | '.$rox_gre.' | '.$rox_gre_info2.'</td>
                        </tr>
            ...
            if ($rox_dis_status == 1){
                ...
                echo ' <tr>
                            <td colspan="4">'.$rox_prd_name. ' ('.$rox_dis_ti.')% - '.$rox_gre_des.' | '.$rox_gre_info.' | '.$rox_gre.' | '.$rox_gre_info2.'</td>
                        </tr>
                        <tr class="item">
