                                ...
                                <div class="form-group col-sm-2">
								 ...
								 <button class="btn btn-primary waves-effect waves-light" type="submit">Search</button>
									<div class="col-sm-8">
                                        ...
                                        ?>
										<div class="input-daterange input-group" id="date-range" style="z-index: 1000">
											<input type="text" class="form-control" value="<?php if (isset($_GET['from_date']))
                                            { echo $f_date;}?>" name="from_date" />
											<span class="input-group-addon bg-custom b-0 text-white">to</span>
											<input type="text" class="form-control" value="<?php  if (isset($_GET['from_date']))
                                            { echo $t_date;}?>" name="to_date" />
										</div>
                                        <select name="pay_method" class="selectpicker" data-live-search="true"  data-style="btn-white">
                        ...
                        <div class="card-box">                           
                            <table id="demo-foo-filtering" class="table table-striped toggle-circle m-b-0" data-page-size="100">
                                ...
                                include("class/class_orders.php");
                                        ...
                                        $payment_method=class_orders::select_from_payment($pay,$from_date,$to_date);
                                    

                                while($data=mysqli_fetch_array($payment_method)){
                                    ...
                                    $rox_ord_status=$data['rox_inv_status'];
                                    $rox_inv_balance=$data['rox_inv_balance'];
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $data['rox_del_date'].'-'.$data['rox_inv_time'];?></td>
                            ...
                            ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="" class="form-control" disabled value="<?php echo $prdct_sum;?>">
                                    </div>
                                </div>
