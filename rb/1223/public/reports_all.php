                ...
                if (isset($_GET['status'])) {
                    ...
                    if ($status == 'success') {
                        echo '<div class="alert alert-success alert-dismissable">
												...
												<b>File (Report_all.csv) Downloaded to "Report_all.csv"</b>
												</div>';
                    }
                    if ($status == 'failed') {
...
<!--                                                            <input type="text" name="payment" parsley-trigger="change" required placeholder="Enter payment" class="form-control" id="payment1" value="--><?php //echo $rox_pay_status?><!--">-->
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <a href="functions/function_excell.php?out_all=yes" class="btn btn-inverse waves-effect waves-light printid" id="btnPrint"><i class="glyphicon glyphicon-export"></i> Export</a>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
