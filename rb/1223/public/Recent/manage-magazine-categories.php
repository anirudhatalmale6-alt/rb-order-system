...
$pagetitle = ' - Manage Magazine Category';
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Manage Magazine Categories</h4>
                        <ol class="breadcrumb">
                            <li><a href="#"><?php echo $companyname; ?></a></li>
                            <li><a href="#">Magazine</a></li>
                            <li class="active">Magazine Categories</li>
                        </ol>
                    </div>
                </div>
				
				<div class="card-box">
					<form action="functions/function_admin_login.php" enctype="multipart/form-data" method="POST" data-parsley-validate novalidate>
						<div class="row">						
							<div class="col-lg-12">
								<div class="card-box-rox">
									<h4 class="m-t-0 header-title"><b>Feed Magazine Categories</b></h4>
									<p class="text-muted font-13 m-b-30">
										Feed Magazine Categories on this page to upload magazines.
									</p>
									
									<div class="form-group col-lg-3">
										<label for="userName">MAG CAT ID#</label>
										<input type="text" name="mag_id" parsley-trigger="change" value="<?php include('class/class_autoid.php');
	echo $auto_id = Autoid::get_magazine_cate_id(); ?>" required placeholder="MAG CAT ID#" class="form-control" id="userName" readonly>
									</div>									
									<div class="form-group col-lg-4">
										<label for="userName">Magazine Category</label>
										<input type="text" name="mag_cate" parsley-trigger="change" required placeholder="Enter Magazine Category" class="form-control" id="userName">
									</div>	
									<div class="form-group col-lg-5">
										<label for="userName">Magazine Category Description</label>
										<input type="text" name="mag_des" parsley-trigger="change" required placeholder="Enter Magazine Category Description" class="form-control" id="userName">
									</div>	
								</div>
							</div>
						</div>
						<div class="row">				
							<div class="form-group text-center m-b-0">
								<button name="save_mage_cate" class="btn btn-primary waves-effect waves-light" type="submit">
									Submit
								</button>
                            ...
                            <table class="table table-striped" id="datatable-editable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Magazine Category Description</th>
                                        <th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
								 <?php
									...
									$select_magazine_category = Page::select_magazine_category();
									while ($row1 = mysqli_fetch_array($select_magazine_category)) {
									?>  
								
                                    <tr class="gradeA">
                                        <td><?php echo $row1['rox_mag_auto_id']; ?></td>
                                        <td><?php echo $row1['rox_mag_cate']; ?></td>
                                        <td><?php echo $row1['rox_mag_cate_des']; ?></td>
                                        <td class="actions">
	    ...
	    <script src="assets/site/pages/datatables.editable.init.magazine.category.js"></script>
