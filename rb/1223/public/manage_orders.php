...
<!--                                                    <table>-->
                                                    ...
                                                    <div class="divTableCell">
                                                        ...
                                                        <input min="<?= date('Y-m-d')?>" onchange="MDate(this.value)" class="form-control" name="invoice[rox_inv_due]" value="<?php echo $data23['rox_inv_due'];?>" type="date"></div>
                                                    
                                                    <div class="divTableCell">
                                                        <label>Delivery Date </label>
                                                        <input min="<?= date('Y-m-d')?>" onchange="TDate(this.value)" class="form-control" name="invoice[delivery_date]" value="<?php echo $data23['rox_del_date'];?>" type="date"></div>
                                                    <div class="divTableCell">
...
var UserDate = value;
var ToDate = new Date(yyyy,mm,dd,24, 59, 30);
