                    ...
                    <form method="GET" action="#" data-parsley-validate novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" >
                                ...
                                <h4 class="m-t-0 header-title"><b>Payment Reports</b></h4>
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                            ...
                                            <select class="form-control" name="payment_type">
                                                ...
                                                <option <?= ($payment_type=='Cash') ? "Selected":"" ?> value="Cash">Cash</option>

                                                <option <?= ($payment_type=='Card') ? "Selected":"" ?> value="Card">Card</option>
                        ...
                        <div class="card-box">                           
                            ...
                            <table id="demo-foo-filtering" class="table table-striped toggle-circle m-b-0" data-page-size="100" border="0">
...

                              {
                                ...
                                $get_cus_details=Report::get_cus_details($fromdate,$enddate,$payment_type);
...

                                {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['cus_fname'];?> (Advance)</td>
                                        ...
                                        <td align="right"><?php echo  number_format($adv,2);?></td>
                            ...
                            ?>
                               ...
                               <!-- tr>
                                    ...
                                    <td style="font-weight: bolder;" align="right"><?php echo  number_format($paid_sum1,2);?></td>
...

                              {
                                ...
                                $get_paid_details=Report::get_paid1($fromdate,$enddate,$payment_type);

                                while($roww=mysqli_fetch_array($get_paid_details))

                                {

                                    $invidd=$roww['rox_inv_id'];

                                    $cusname=$roww['cus_fname'];

                                    $paidamnt=$roww['totpaid'];
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <a onclick="window.open('invoice-A5?inv_code=<?php echo $invidd;  ?>&from_date=<?php echo $f_date;  ?>&to_date=&user_id=&p_status=&d_status=&','My Win','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=0,width=450,height=660',); return false;"  class="wm-default-btn"><span><?php echo $invidd;  ?></span></a>
                                        ...
                                        <td><?php echo $roww['rox_pay_typ'];?></td>



                                        <td align="right"><?php echo  number_format($paidamnt,2);?></td>
                               ...
                               <!--  <tr>
                                    ...
                                    <td style="font-weight: bolder;" align="right"><?php echo  number_format($paid_sum+$paid_sum1,2);?></td>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="functions/function_excell.php?all_payment=yes&<?php echo $_SERVER['QUERY_STRING']?>" class="btn btn-inverse waves-effect waves-light printid" id="btnPrint"><i class="fa fa-print"></i> Export</a>
