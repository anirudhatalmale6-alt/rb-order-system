...
class class_payment
{
    ...
    public static function balance_payment($inid="",$cusid="",$type="",$pay="")
    {
        include("../library/dbcon.php");

        $sql2 = "INSERT INTO `rox_balance_payment`(`rox_bid`, `rox_inv_id`, `rox_cust_id`, `rox_pay_typ`,`rox_payment`) VALUES ('','$inid',$cusid,'$type',$pay)";
