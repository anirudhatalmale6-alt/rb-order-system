...
//    }
    ...
    public  static function seleect_all_from_odr_info2($from_date=""){
        include("library/dbcon.php");
        echo $sql1="SELECT * FROM rox_order_info WHERE rox_inv_id='$from_date' AND `rox_ord_status`!='Cancelled' ";
        exit();
        $result=mysqli_query($conn,$sql1);
        return $sql1;
        mysqli_close($conn);
...
//-------------------------------------------------------------------------------------------------------
    ...
    public static function update_invoice_delivery_details($inv_id,$delivery_date,$delivery_time)
    {
        include("../library/dbcon.php");
        $sql="UPDATE rox_invoice SET rox_del_date='$delivery_date',rox_inv_time='$delivery_time' WHERE rox_inv_auto_id='$inv_id'";
        $result=mysqli_query($conn,$sql);
        if($result=true)
        {
            return 1;
